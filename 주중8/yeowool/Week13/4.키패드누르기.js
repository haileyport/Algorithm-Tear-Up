// [PGS] [카카오 인턴] 키패드 누르기 / leve1
// 난이도 :  level 1
// 풀이시간 :  실패해서 다른분의 코드를 가져와 의사코드 작성했습니다ㅜㅜ
// 점수 : 
...
/*
< 의사코드 >
1. 키패드의 최 하단의 * 0 #은 10 11 12 라고 생각한다.
    이렇게 되면 1~12번까지의 번호판이 된다
2. for문으로 numbers만큼 순회하면서 왼손일 경우와 오른손일 경우를 나눈다.
..?
*/
...
테스트 19 〉	통과 (0.41ms, 33.4MB)
테스트 20 〉	통과 (0.65ms, 33.5MB)
*/
